...
export const DRANKEN: ReadyMadeItem[] = [
  ...
  { id: "mangajo-acai",           name: "Mangajo Açaí Berry & Green Tea",  emoji: "🍵", price: 4.00, description: "", ingredients: "", tags: [], info: "Geen toegevoegde suikers." },
  { id: "mangajo-pomegranate",    name: "Mangajo Pomegranate & Green Tea", emoji: "🍵", price: 4.00, description: "", ingredients: "", tags: [], info: "Geen toegevoegde suikers." },
  ...
  { id: "mangajo-red-grape",      name: "Mangajo Red Grape & Rooibos",     emoji: "🍵", price: 4.00, description: "", ingredients: "", tags: [], info: "Geen toegevoegde suikers." },
  { id: "mocktail-mojito",        name: "Mocktail Mojito",                 emoji: "🌿", price: 4.50, description: "", ingredients: "", tags: [] },
  { id: "mocktail-passion",       name: "Mocktail Passion Fruit Martini",  emoji: "🍸", price: 4.50, description: "", ingredients: "", tags: [] },
  { id: "mocktail-ginger-mule",   name: "Mocktail Ginger Mule",            emoji: "🫚", price: 4.50, description: "", ingredients: "", tags: [] },
  { id: "grannys-secret",         name: "Granny's Secret",                 emoji: "🍷", price: 3.00, description: "Huisgemaakte drank van rood fruit.", ingredients: "", tags: [] },
  { id: "espresso",               name: "Espresso",                        emoji: "☕", price: 2.50, description: "", ingredients: "", tags: [] },
  { id: "koffie",                 name: "Koffie",                          emoji: "☕", price: 3.00, description: "", ingredients: "", tags: [] },
  { id: "cappuccino",             name: "Cappuccino",                      emoji: "☕", price: 3.50, description: "", ingredients: "", tags: [] },
  { id: "latte-macchiato",        name: "Latte Macchiato",                 emoji: "☕", price: 4.00, description: "", ingredients: "", tags: [] },
  { id: "iced-latte",             name: "Iced Latte",                      emoji: "🧋", price: 4.50, description: "", ingredients: "", tags: [] },
  { id: "thee-earl-grey",         name: "Zwarte thee (Earl Grey)",         emoji: "🍵", price: 3.00, description: "", ingredients: "", tags: [] },
  { id: "thee-bosvruchten",       name: "Zwarte thee (bosvruchten)",       emoji: "🍵", price: 3.00, description: "", ingredients: "", tags: [] },
  { id: "thee-groen",             name: "Groene thee",                     emoji: "🍵", price: 3.00, description: "", ingredients: "", tags: [] },
  { id: "thee-munt",              name: "Munt thee",                       emoji: "🌿", price: 3.00, description: "", ingredients: "", tags: [] },
  { id: "thee-kamille",           name: "Kamille thee",                    emoji: "🌼", price: 3.00, description: "", ingredients: "", tags: [] },
  { id: "warme-chocomelk",        name: "Warme chocomelk",                 emoji: "🍫", price: 3.50, description: "", ingredients: "", tags: [] },
  { id: "mocha-latte",            name: "Mocha Latte",                     emoji: "☕", price: 4.50, description: "", ingredients: "", tags: [] },
  { id: "chai-latte",             name: "Chai Latte",                      emoji: "☕", price: 4.50, description: "", ingredients: "", tags: [] },
  { id: "dirty-chai-latte",       name: "Dirty Chai Latte",                emoji: "☕", price: 5.50, description: "", ingredients: "", tags: [] },
  { id: "siroop-caramel",         name: "Extra: caramel siroop",           emoji: "🍯", price: 0.50, description: "", ingredients: "", tags: [] },
  { id: "siroop-vanille",         name: "Extra: vanille siroop",           emoji: "🌼", price: 0.50, description: "", ingredients: "", tags: [] },
  { id: "siroop-hazelnoot",       name: "Extra: hazelnoot siroop",         emoji: "🌰", price: 0.50, description: "", ingredients: "", tags: [] },
];
