...
const nl: Dict = {
  ...
  "legal.allergens_intro": "Onderstaande tabel geeft de 14 wettelijk verplichte allergenen weer per product. Samengestelde bowls, burrito's (wrap bevat gluten) en rolls kunnen extra allergenen bevatten afhankelijk van uw keuze. Desserten en dranken: indicatief — raadpleeg verpakking of vraag ons.",
  ...
  "legal.allergens_disclaimer": "Deze informatie is indicatief. Recepten en toeleveranciers kunnen wijzigen. Er kan kruisbesmetting optreden in onze keuken.",
...
const en: Dict = {
  ...
  "legal.allergens_intro": "The table below lists the 14 legally required allergens per product. Custom bowls, burritos (wrap contains gluten) and rolls may contain additional allergens depending on your choices. Desserts and drinks: indicative — check packaging or ask us.",
  ...
  "legal.allergens_disclaimer": "This information is indicative. Recipes and suppliers may change. Cross-contamination may occur in our kitchen.",
...
const fr: Dict = {
  ...
  "legal.allergens_intro": "Le tableau ci-dessous indique les 14 allergènes légalement requis par produit. Bowls, burritos (wrap contient du gluten) et rolls personnalisés peuvent contenir des allergènes supplémentaires. Desserts et boissons : indicatif — consultez l'emballage ou contactez-nous.",
  ...
  "legal.allergens_disclaimer": "Ces informations sont indicatives. Recettes et fournisseurs peuvent changer. Contamination croisée possible en cuisine.",
