...
const nl: Dict = {
  ...
  "payment.stripe_loading": "Betaling laden… even geduld.",
  "payment.stripe_wait": "Wacht tot het betaalformulier klaar is.",
...
const en: Dict = {
  ...
  "payment.stripe_loading": "Loading payment… please wait.",
  "payment.stripe_wait": "Wait until the payment form is ready.",
...
const fr: Dict = {
  ...
  "payment.stripe_loading": "Chargement du paiement… veuillez patienter.",
  "payment.stripe_wait": "Attendez que le formulaire de paiement soit prêt.",
